    ...
    StatefulShellRoute.indexedStack(
        ...
        branches: [
          StatefulShellBranch(routes: [
            GoRoute(path: AppRoutes.overview, name: 'overview', builder: (context, state) => HomeScreen()),
          ]),
          StatefulShellBranch(routes: [
            GoRoute(path: AppRoutes.wallet, name: 'wallet', builder: (context, state) => WalletShellScreen(),)
          ]),
          StatefulShellBranch(routes: [
            GoRoute(path: AppRoutes.addTransaction, name: 'add-transaction', builder: (context, state) => AddTransactionScreen(),)
          ]),
          StatefulShellBranch(routes: [
            GoRoute(path: AppRoutes.stats, name: 'stats', builder: (context, state) => StatsShellScreen(),)
          ]),
          StatefulShellBranch(routes: [
