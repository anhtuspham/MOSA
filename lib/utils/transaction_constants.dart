...
class TransactionConstants {
  ...
  static const String errorSelectSourceAccount =
      'Vui lòng chọn tài khoản nguồn';
  static const String errorSelectDestAccount = 'Vui lòng chọn tài khoản đích';
  static const String errorSameAccount =
      'Không thể chuyển khoản vào cùng một tài khoản';
  static const String errorBalanceEqual =
      'Số dư thực tế giống với số dư hiện tại';
  static const String errorSelectDebtToCollect =
      'Vui lòng chọn khoản nợ cần thu';
  ...
  static String transferToTitle(String walletName) =>
      'Chuyển khoản đến $walletName';
  static String transferFromTitle(String walletName) =>
      'Nhận chuyển khoản từ $walletName';
  static String transactionWithPerson(String personName) =>
      'Giao dịch với $personName';
  static String payDebtTitle(String description) =>
      'Thanh toán nợ: $description';
